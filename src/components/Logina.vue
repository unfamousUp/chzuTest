<template>
    <div class="login-container">
        <div class="content">
            ...
            <div class="right">
                <div class="top">
                    <h1 id="poorTitle">基于集成学习的高校贫困生隐性资助认定系统</h1>
                </div>
                <div class="form-wrappepr">
                    <input type="text" v-model="user.account" class="inputs user" placeholder="Enter Email Or Number">
                    <input type="password" v-model="user.password" class="inputs pwd" placeholder="Password">
                    <span class="tips">忘记密码</span>
                    <button @click="loginSubmit">登录</button>
                    <div class="other-login">
                        <div class="divider">
                            <span class="line"></span>
                            <span class="divider-text">version 1.0</span>
                            <span class="line"></span>
                        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            toAdminMain() {
                const name = "toAdminMain"
                this.$router.push({
                    name: name
                })
            },
            loginSubmit() {
                if (this.user.account === '203001') {
                    alert("登录成功！")
                    this.toMain()
